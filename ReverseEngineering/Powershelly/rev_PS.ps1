$input = "/home/ayush/Work/picoCTF/ReverseEngineering/Powershelly/input.txt"
...
{
  Write-Output $out.Length
  Write-Output $enc.Count
...
$randoms = Random-Gen
$output_file = @()
Write-Output "randoms"
Write-Output ([system.String]::Join(", ", $randoms))
Write-Output "seeds"
Write-Output ([system.String]::Join(", ", $seeds))
